...
// import { Exception, Cause, CauseCode } from "./exception"
// import { neverPromise, noResult } from "./values"

// export enum ChannelCause {
//     /**
...
//     WriteCase = 203,
// }
// const causeClosed = new Cause(ChannelCause.Closed, 'write to closed channel')
// const causeWriterEmpty = new Cause(CauseCode.Internal, 'channel writer empty')
// const causeReaderEmpty = new Cause(CauseCode.Internal, 'channel reader empty')
// const causeReadCase = new Cause(ChannelCause.ReadCase, 'channel read case not ready')
// const causeWriteCase = new Cause(ChannelCause.WriteCase, 'channel write case not ready')
// export class ChannelException extends Exception {
//     static is(e: any): e is Exception {
//         const v = Exception.getCode(e) ?? 0
//         return ChannelCause.Closed <= v && v <= ChannelCause.WriteCase
//     }
// }
...
//             // chan 已經關閉
//             if (exception) {
//                 throw new ChannelException('channel already closed', causeClosed)
//             }
//             return false
//         } else if (result) {
//             // 寫入 chan 成功
...
//         switch (vals.length) {
//             case 0:
//                 throw new ChannelException('reader empty', causeReaderEmpty)
//             case 1:
//                 vals.pop()!.invoke(val)
//                 return
//         }
...
//         switch (vals.length) {
//             case 0:
//                 throw new ChannelException("writer empty", causeWriterEmpty)
//             case 1:
//                 const p = vals.pop()!
//                 p.invoke()
//                 return p.value
...
//         if (reject) {
//             try {
//                 reject(new ChannelException('channel already closed', causeClosed))
//             } catch (_) {
//             }
//         } else {
//             this.callback(false)
...
//         if (val === undefined) {
//             throw new ChannelException('read case not ready', causeReadCase)
//         }
...
//         if (val === undefined) {
//             throw new ChannelException('write case not ready', causeWriteCase)
//         }
//         return val
//     }
//     /**
