...
import { ValueCallback, DeleteCallback, MapCallback, CloneCallback, CompareCallback, Comparable, compare, ValidCallback } from '../types.ts';
import { classForEach, ClassForEach } from '../internal/decorator.ts';
/**
 * container interface
 * 
 * @remarks
