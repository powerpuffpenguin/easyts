import { noResult } from '../core/values.ts'
import { Exception, errOutOfRange } from '../core/exception.ts';
import { Basic, Options } from './types.ts';
import { CloneCallback, DeleteCallback } from '../core/types.ts';
/**
