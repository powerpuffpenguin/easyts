// import { Defer, DeferException, DeferCause } from "./defer"
...
//             assert.equal(result, 3)
//         } catch (e) {
//             assert.true(DeferException.is(e))
//             if (DeferException.is(e)) {
//                 assert.equal(Cause.getCode(e.cause), DeferCause.Error)
//             }
//         }
//         assert.equal(flag, 6)
//         assert.equal(num, 6)
...
//                 if (DeferException.is(e)) {
//                     assert.equal(Cause.getCode(e.cause), DeferCause.Error)
//                     assert.equal(e.errs.length, 1)
//                     assert.true(e.errs[0] instanceof Error)
//                     assert.equal(e.errs[0].message, 123)
//                 }
//             }
//             assert.equal(flag, 6)
//             assert.equal(num, 6)
