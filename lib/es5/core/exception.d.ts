import { IdentityType } from "./internal/identity";
...
export declare class Exception extends Error {
    private __classid_;
    get classid(): IdentityType;
    private __classname_;
...
export declare type Constructor<T extends Exception> = new (...args: any[]) => T;
export declare function isError<T extends Exception>(v: any, t: Constructor<T>): v is T;
export declare function asError<T extends Exception>(v: any, t: Constructor<T>): T | undefined;
