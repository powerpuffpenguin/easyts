    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    if (n < min) {
                        throw new IOException(ErrorCode.UnexpectedEOF, "readAtLeast read ".concat(n, " bytes, ").concat(min, " bytes less than expected"));
                    }
                    return [2 /*return*/, n];
            }
        });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    num += nw;
                    if (nw < 0 || nr < nw) {
                        throw new IOException(ErrorCode.InvalidWrite, "io returned an invalid number of bytes written, read=".concat(nr, " write=").concat(nw));
                    }
                    if (nr != nw) {
                        throw new IOException(ErrorCode.ShortWrite, "io writes fewer bytes than reads, read=".concat(nr, " write=").concat(nw));
                    }
                    return [3 /*break*/, 1];
