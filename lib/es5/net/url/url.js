...
var InvalidHostException = /** @class */ (function (_super) {
    ...
    function InvalidHostException(msg) {
...
var URLException = /** @class */ (function (_super) {
    ...
    URLException.prototype.unwrap = function () {
        return this.err;
    };
    URLException.prototype.error = function () {
        return "".concat(this.op, " '").concat(this.url, "': ").concat(this.err.error());
    };
    URLException.prototype.timeout = function () {
        return this.err.timeout();
    };
    URLException.prototype.temporary = function () {
...
var Values = /** @class */ (function () {
     ...
     */
    Values.parse = function (query, errs, first) {
        var _a, _b;
        var _c;
        ...
        var key;
        var value;
        var n = (_c = errs === null || errs === void 0 ? void 0 : errs.length) !== null && _c !== void 0 ? _c : 0;
        while (query != "") {
            _a = __read(stringsCut(query, '&'), 2), key = _a[0], query = _a[1];
            if (key.indexOf(';') >= 0) {
                if (errs) {
                    if (!first || n == errs.length) {
                        errs.push(new core_1.Exception('invalid semicolon separator in query'));
                    }
                }
                continue;
            }
...
function getScheme(rawURL) {
    for (var i = 0; i < rawURL.length; i++) {
        ...
        if ((97 <= c && c <= 122) || (65 <= c && c <= 90)) { // 'a' <= c && c <= 'z' || 'A' <= c && c <= 'Z'
            ...
            if (i == 0) {
                throw new core_1.Exception('missing protocol scheme');
            }
...
function parseAuthority(authority) {
    ...
    if (!validUserinfo(userinfo)) {
        throw new core_1.Exception('net/url: invalid userinfo');
    }
    var user;
...
function parseHost(host) {
    if (host.startsWith('[')) {
        ...
        if (i < 0) {
            throw new core_1.Exception("missing ']' in host");
        }
        var colonPort = host.substring(i + 1);
        if (!validOptionalPort(colonPort)) {
            throw new core_1.Exception("invalid port ".concat(colonPort, " after host"));
        }
...
var URL = /** @class */ (function () {
    ...
    URL._parse = function (rawURL, viaRequest) {
        ...
        if (stringContainsCTLByte(rawURL)) {
            throw new core_1.Exception('net/url: invalid control character in URL');
        }
        if (rawURL == "" && viaRequest) {
            throw new core_1.Exception('empty url');
        }
        var url = new URL();
        if (rawURL == "*") {
            url.path = "*";
        ...
        if (!rest.startsWith('/')) {
            ...
            if (viaRequest) {
                throw new core_1.Exception('invalid URI for request');
            }
            ...
            if (segment.indexOf(':') >= 0) {
                ...
                throw new core_1.Exception('first path segment in URL cannot contain colon');
            }
        }
     ...
     * @returns always returns a map containing all the valid query parameters found
     */
    URL.prototype.query = function (errs, first) {
        if (first === void 0) { first = true; }
        if (this.rawQuery === '') {
            return new Values();
        }
