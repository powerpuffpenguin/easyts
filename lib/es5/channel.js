...
var Values = /** @class */ (function () {
    ...
    Values.prototype.pop = function () {
        var val = this.vals.pop();
        this.keys.delete(val);
        return val;
    };
    Values.prototype.removeBy = function (i) {
        var vals = this.vals;
        var swap = vals.pop();
        var keys = this.keys;
        if (i == vals.length) {
    ...
    Values.prototype.remove = function (val) {
        var _a;
        var keys = this.keys;
        var vals = this.vals;
        var i = (_a = keys.get(val)) !== null && _a !== void 0 ? _a : -1;
        if (i < 0) {
            return;
        }
        var swap = vals.pop();
...
var Reader = /** @class */ (function () {
    ...
    Reader.prototype.close = function () {
        ...
        if (vals.length != 0) {
            try {
                for (var _b = __values(vals.vals), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var val = _c.value;
