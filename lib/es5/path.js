...
var lazybuf = /** @class */ (function () {
    ...
    lazybuf.prototype.toString = function () {
        var buf = this.buf;
        if (buf) {
            buf.splice(this.w);
            return buf.join('');
...
function join() {
    ...
    var buf = new Array();
    try {
        for (var elem_1 = __values(elem), elem_1_1 = elem_1.next(); !elem_1_1.done; elem_1_1 = elem_1.next()) {
            var e = elem_1_1.value;
            if (e != '') {
                buf.push(e);
            }
        }
        ...
        try {
            if (elem_1_1 && !elem_1_1.done && (_a = elem_1.return)) _a.call(elem_1);
        }
