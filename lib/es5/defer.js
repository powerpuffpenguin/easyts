...
var Defer = /** @class */ (function () {
    ...
    Defer.prototype._syncDone = function () {
        var fs = this.fs_;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        e_1 = _a.sent();
                        return [4 /*yield*/, d._asyncDone()];
                    case 4:
                        _a.sent();
                        throw e_1;
                    case 5: return [4 /*yield*/, d._asyncDone()];
                    case 6:
                        _a.sent();
    ...
    Defer.prototype._asyncDone = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fs, i, f, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        e_2 = _a.sent();
                        logger_1.defaultLogger.log('defer.async', e_2);
                        return [3 /*break*/, 5];
                    case 5:
                        i--;
                        return [3 /*break*/, 1];
