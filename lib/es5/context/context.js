...
var EmptyCtx = /** @class */ (function () {
    ...
    EmptyCtx.prototype.get = function (_) {
        return undefined;
    };
    EmptyCtx.prototype.getRaw = function (key) {
...
var ValueCtx = /** @class */ (function () {
    ...
    ValueCtx.prototype.get = function (key) {
        ...
        var val = value(this.parent, key);
        return val[0];
    };
    ValueCtx.prototype.getRaw = function (key) {
        if (this.key === key) {
...
var CancelCtx = /** @class */ (function () {
    ...
    CancelCtx.prototype.get = function (key, exists) {
        if (cancelCtxKey === key) {
    ...
    CancelCtx.prototype.getRaw = function (key) {
        if (cancelCtxKey === key) {
            return [this, true];
        }
        var val = value(this.parent, key);
...
function parentCancelCtx(parent) {
    ...
    var _a = __read(parent.getRaw(cancelCtxKey), 2), p = _a[0], ok = _a[1];
    if (!ok) {
        return;
    }
    if (done !== p.done_) {
