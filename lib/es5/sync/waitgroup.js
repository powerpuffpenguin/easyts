...
var WaitGroupException = /** @class */ (function (_super) {
    __extends(WaitGroupException, _super);
    function WaitGroupException(msg) {
        return _super.call(this, msg) || this;
    }
    return WaitGroupException;
...
var WaitGroup = /** @class */ (function () {
    ...
    WaitGroup.prototype.add = function (delta) {
        ...
        if (!isFinite(v) || v != delta) {
            throw new WaitGroupException("delta must be a integer: ".concat(delta));
        }
        v += this.counter_;
        if (v === 0) {
            this.counter_ = v;
            ...
            throw new WaitGroupException("negative WaitGroup counter: ".concat(v));
        }
        else if (!isFinite(v)) {
            throw new WaitGroupException("invalid WaitGroup counter: ".concat(v));
        }
        else {
            this.counter_ = v;
        }
