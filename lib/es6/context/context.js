...
class CanceleException extends exception_1.Exception {
    constructor(message, opts) {
        super(message !== null && message !== void 0 ? message : 'context canceled', opts);
        this.canceled = true;
    }
}
...
class DeadlineExceeded extends exception_1.Exception {
    constructor(message, opts) {
        super(message !== null && message !== void 0 ? message : 'context deadline exceeded', opts);
        this.timeout = true;
        this.temporary = true;
    }
}
...
function propagateCancel(parent, child) {
    ...
    if (p) {
        ...
        (() => __awaiter(this, void 0, void 0, function* () {
            switch (yield (0, channel_1.selectChan)(rp, rc)) {
                case rp:
                    child._cancel(false, parent.err);
                    break;
                case rc:
