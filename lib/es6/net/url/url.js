...
class URLException extends core_1.Exception {
...
class Values {
    ...
    static parse(query, errs, first = true) {
        ...
        let key;
        let value;
        let n = (_a = errs === null || errs === void 0 ? void 0 : errs.length) !== null && _a !== void 0 ? _a : 0;
        while (query != "") {
...
function parseHost(host) {
    if (host.startsWith('[')) {
        ...
        if (!validOptionalPort(colonPort)) {
            throw new core_1.Exception(`invalid port ${colonPort} after host`);
        }
