...
class InvalidHostException extends exception_1.Exception {
    /**
     *
     * @internal
     */
...
class EscapeException extends exception_1.Exception {
    /**
     *
     * @internal
     */
...
class URLException extends exception_1.Exception {
...
function parseHost(host) {
    if (host.startsWith('[')) {
        ...
        if (!validOptionalPort(colonPort)) {
            throw new exception_1.Exception(`invalid port ${colonPort} after host`);
        }
