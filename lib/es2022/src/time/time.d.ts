...
export declare class TimeException extends Exception {
}
 ...
 * @throws {@link TimeException} if ms <= 0
 */
export declare function tick(ms: number): ReadChannel<Date>;
/**
 * The callback is called whenever the duration elapses
 * @throws {@link TimeException} if ms <= 0
 */
export declare function tickFunc(ms: number, callback: ValueCallback<Date>): Ticker;
